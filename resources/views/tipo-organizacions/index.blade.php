<x-app-layout>
    <x-slot name="header">
        <h2 class="font-semibold text-xl text-gray-800 dark:text-gray-200 leading-tight text-center">
            {{ __('Gestión de Tipos de Organización') }}
        </h2>
    </x-slot>
        ...
        <div class="w-full max-w-6xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-gradient-to-br from-white to-gray-50 dark:from-gray-800 dark:to-gray-900 
                ...
                <div class="flex flex-col md:flex-row justify-between items-center mb-8 gap-4">
                    ...
                    <a href="{{ route('tipo-organizacions.create') }}" 
                       class="w-full md:w-auto inline-flex items-center justify-center px-8 py-3 
                        ...
                        <i class="fas fa-plus-circle mr-2 text-lg"></i> Crear Tipo de Organización
                    </a>
                    ...
                    <div class="relative w-full md:w-1/2">
                        ...
                        <input type="text" id="search-input" placeholder="Buscar por ID o Nombre de organización..."
                ...
                <div class="overflow-x-auto rounded-xl border border-gray-200 dark:border-gray-700 shadow-xl">
                    <table class="min-w-full divide-y divide-gray-200 dark:divide-gray-700">
                        <thead class="bg-gray-100 dark:bg-gray-700">
                            <tr>
                                ...
                                <th scope="col" class="px-6 py-3 text-left text-xs font-bold text-gray-600 dark:text-gray-300 uppercase tracking-wider w-1/2">
                                    <i class="fas fa-sitemap mr-1"></i> Nombre
                                </th>
                        ...
                        <tbody id="tipos-organizacion-table-body" class="bg-white dark:bg-gray-800 divide-y divide-gray-100 dark:divide-gray-700">
                            {{-- Contenido de tipo-organizacions.partials.tipo_organizacion_table_rows --}}
                    ...
                    <div id="no-results-message" class="hidden p-10 text-center bg-white dark:bg-gray-800">
                        <i class="fas fa-building text-5xl text-blue-400 dark:text-blue-600 mb-3"></i>
                        <p class="font-extrabold text-xl text-gray-900 dark:text-white">¡Vaya! No hay coincidencias.</p>
                        <p class="text-gray-500 dark:text-gray-400 mt-2">Intenta cambiar los términos de búsqueda o crea un nuevo tipo de organización.</p>
                    </div>
                </div>
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function () {
            ...
            // Nota: Asumo que el token CSRF está disponible en el layout principal.
            ...
            function attachPaginationListeners() {
                paginationLinksContainer.querySelectorAll('a').forEach(link => {
                    ...
                    newLink.addEventListener('click', function(e) {
                        ...
                        window.history.pushState({}, '', `{{ route('tipo-organizacions.index') }}?page=${page}&search=${encodeURIComponent(searchInput.value)}`);
            ...
            function fetchTiposOrganizacion(page = 1) {
                ...
                tiposOrganizacionTableBody.innerHTML = '<tr><td colspan="3" class="p-6 text-center text-blue-500 dark:text-blue-400"><i class="fas fa-spinner fa-spin mr-2"></i> Cargando tipos de organización...</td></tr>';
                ...
                .catch(error => {
                    ...
                    tiposOrganizacionTableBody.innerHTML = '<tr><td colspan="3" class="p-6 text-center text-red-500 dark:text-red-400"><i class="fas fa-exclamation-triangle mr-2"></i> Error al cargar.</td></tr>';
