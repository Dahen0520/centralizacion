            ...
            <div class="bg-gradient-to-br from-white to-gray-50 dark:from-gray-800 dark:to-gray-900 
                ...
                <div class="text-center mb-10">
                    <div class="inline-flex items-center justify-center w-20 h-20 rounded-full 
                         ...
                         <i class="fas fa-sitemap text-4xl"></i> {{-- Icono para organización/estructura --}}
                    </div>
                    <h3 class="text-3xl font-extrabold text-gray-900 dark:text-white mb-2 leading-tight">
                        Registrar Tipo de Organización
                    </h3>
                    <p class="text-md text-gray-600 dark:text-gray-400 max-w-md mx-auto">
                        Introduce la figura legal o naturaleza de la entidad (e.g., S.A., S.R.L., ONG).
                    </p>
                ...
                <form method="POST" action="{{ route('tipo-organizacions.store') }}">
                    ...
                    <div class="mb-8">
                        ...
                        <input type="text" id="nombre" name="nombre" value="{{ old('nombre') }}" required 
                               placeholder="Ej: Sociedad Anónima (S.A.), Cooperativa, Unipersonal..."
                    ...
                    <button type="submit" 
                        ...
                        <i class="fas fa-save mr-2"></i> Guardar Tipo de Organización
                    </button>
                </form>
            </div>
        </div>
