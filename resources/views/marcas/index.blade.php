        ...
        <div class="w-full max-w-6xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-xl sm:rounded-lg p-8 border-t-8 border-blue-600">
                <div class="flex justify-between items-center mb-6">
                    <a href="{{ route('marcas.create') }}" class="inline-flex items-center px-4 py-2 bg-blue-600 border border-transparent rounded-md font-semibold text-xs text-white uppercase tracking-widest hover:bg-blue-500 active:bg-blue-700 focus:outline-none focus:border-blue-700 focus:ring ring-blue-300 disabled:opacity-25 transition ease-in-out duration-150">
                        <i class="fas fa-plus mr-2"></i> Crear Marca
                    </a>
                </div>

                {{-- Barra de búsqueda --}}
                <div class="mb-4">
                    <input type="text" id="search-input" placeholder="Buscar marcas por nombre de producto..."
                    ...
                    <table class="min-w-full divide-y divide-gray-200 dark:divide-gray-700">
                        <thead class="bg-gray-50 dark:bg-gray-700">
                            <tr>
                                ...
                                <th scope="col" class="px-6 py-3 text-left text-xs font-medium text-gray-500 dark:text-gray-300 uppercase tracking-wider">Código de Marca</th>
                        ...
                        <tbody id="marcas-table-body" class="bg-white dark:bg-gray-800 divide-y divide-gray-200 dark:divide-gray-700">
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function () {
                    ...
                    if (result.isConfirmed) {
                        ...
                        .then(data => {
                            if (data.success) {
                                ...
                                Swal.fire(
                                    'Error',
                                    data.message || 'No se pudo eliminar la marca.',
                                    'error'
                                );
                            }
                        })
            ...
            function fetchMarcas(page = 1) {
                ...
                const url = `{{ route('marcas.index') }}?page=${page}&search=${encodeURIComponent(query)}`;
                ...
                .catch(error => {
                    ...
                    Swal.fire(
                        'Error de Carga',
                        'No se pudieron cargar las marcas. Inténtalo de nuevo. Detalles: ' + error.message,
                        'error'
                    );
                });
            }
            ...
            searchInput.addEventListener('keyup', function () {
                ...
                searchTimeout = setTimeout(() => {
                    fetchMarcas(1); // Siempre ir a la primera página al buscar
                }, 300);
            });
