            ...
            <div class="bg-gradient-to-br from-white to-gray-50 dark:from-gray-800 dark:to-gray-900 
                ...
                <div class="text-center mb-10">
                    ...
                    <h3 class="text-3xl font-extrabold text-gray-900 dark:text-white mb-2 leading-tight">
                        Modificar Impuesto: <span class="text-purple-600 dark:text-purple-400">{{ $impuesto->nombre }}</span>
                    </h3>
                    <p class="text-md text-gray-600 dark:text-gray-400 max-w-md mx-auto">
                        Actualiza el nombre y el porcentaje de la tasa impositiva seleccionada.
                    </p>
                ...
                <form method="POST" action="{{ route('impuestos.update', $impuesto) }}">
                    @csrf
                    @method('PUT') {{-- NECESARIO para las rutas de actualización --}}
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-x-6 gap-y-8">
                        ...
                        <div>
                            ...
                            <input type="text" id="nombre" name="nombre" value="{{ old('nombre', $impuesto->nombre) }}" required 
                        ...
                        <div>
                            ...
                            <div class="relative">
                                <input type="number" id="porcentaje" name="porcentaje" value="{{ old('porcentaje', $impuesto->porcentaje) }}" required step="0.01" min="0" max="100"
                    ...
                    <button type="submit" 
                        ...
                        <i class="fas fa-sync-alt mr-2"></i> Actualizar Impuesto
                    </button>
                </form>
            </div>
        </div>
