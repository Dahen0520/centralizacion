            ...
            <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-xl sm:rounded-lg p-8 border-t-8 border-blue-600">
                <div class="flex justify-between items-center mb-6">
                    <a href="{{ route('rubros.create') }}" class="inline-flex items-center px-4 py-2 bg-blue-600 border border-transparent rounded-md font-semibold text-xs text-white uppercase tracking-widest hover:bg-blue-500 active:bg-blue-700 focus:outline-none focus:border-blue-700 focus:ring ring-blue-300 disabled:opacity-25 transition ease-in-out duration-150">
                        <i class="fas fa-plus mr-2"></i> Crear Rubro
                    </a>
                </div>

                {{-- Barra de búsqueda --}}
                <div class="mb-4">
                    <input type="text" id="search-input" placeholder="Buscar rubros por nombre..."
                ...
                <div class="overflow-x-auto">
                    <table class="min-w-full divide-y divide-gray-200 dark:divide-gray-700">
                        ...
                        <tbody id="rubros-table-body" class="bg-white dark:bg-gray-800 divide-y divide-gray-200 dark:divide-gray-700">
                            {{-- Los rubros se cargarán aquí --}}
...
<script>
    document.addEventListener('DOMContentLoaded', function () {
        ...
        function handleDeleteClick(e) {
            ...
            const rubroId = this.getAttribute('data-id');
                ...
                if (result.isConfirmed) {
                    ...
                    .then(data => {
                        if (data.success) {
                            ...
                            Swal.fire(
                                'Error',
                                data.message || 'No se pudo eliminar el rubro.',
                                'error'
                            );
                        }
                    })
        ...
        // Función principal para obtener y mostrar los rubros
        function fetchRubros(page = 1) {
            ...
            .catch(error => {
                ...
                Swal.fire(
                    'Error de Carga',
                    'No se pudieron cargar los rubros. Inténtalo de nuevo. Detalles: ' + error.message,
                    'error'
                );
            });
        }
