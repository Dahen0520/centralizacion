            ...
            <div class="bg-gradient-to-br from-white to-gray-50 dark:from-gray-800 dark:to-gray-900 
                ...
                <div class="text-center mb-10">
                    ...
                    <h3 class="text-3xl font-extrabold text-gray-900 dark:text-white mb-2 leading-tight">
                        Define un nuevo Rubro
                    </h3>
                    <p class="text-md text-gray-600 dark:text-gray-400 max-w-md mx-auto">
                        Añade un sector comercial o tipo de actividad que impulse nuevas oportunidades.
                    </p>
                ...
                <form method="POST" action="{{ route('rubros.store') }}">
                    ...
                    <div class="mb-8">
                        ...
                        <input type="text" id="nombre" name="nombre" value="{{ old('nombre') }}" required 
                               placeholder="Ej: Innovación Tecnológica, Artesanía Exclusiva, Gastronomía Gourmet..."
                    ...
                    <button type="submit" 
                        ...
                        {{-- ÍCONO CAMBIADO DE fa-rocket a fa-save --}}
                        <i class="fas fa-save mr-2"></i> Crear Rubro
                    </button>
                </form>
            </div>
        </div>
