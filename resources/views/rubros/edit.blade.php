<x-app-layout>
    ...
    {{-- CLASES MODIFICADAS AQUÍ: SE REDUJO EL PADDING SUPERIOR (py-6) Y SE ELIMINARON LAS CLASES DE CENTRADO VERTICAL EXCESIVAS --}}
            ...
            <div class="bg-gradient-to-br from-white to-gray-50 dark:from-gray-800 dark:to-gray-900 
                ...
                <div class="text-center mb-10">
                    ...
                    <h3 class="text-3xl font-extrabold text-gray-900 dark:text-white mb-2 leading-tight">
                        Modificar Rubro: <span class="text-blue-600 dark:text-blue-400">{{ $rubro->nombre }}</span>
                    </h3>
                    <p class="text-md text-gray-600 dark:text-gray-400 max-w-md mx-auto">
                        Asegúrate de que el nombre del rubro refleje con precisión la categoría de negocio.
                    </p>
                ...
                <form method="POST" action="{{ route('rubros.update', $rubro) }}">
                    ...
                    <button type="submit" 
                        ...
                        <i class="fas fa-sync-alt mr-2"></i> Actualizar Rubro
                    </button>
                </form>
            </div>
        </div>
