            ...
            <div class="bg-gradient-to-br from-white to-gray-50 dark:from-gray-800 dark:to-gray-900 
                ...
                <div class="text-center mb-10">
                    ...
                    <p class="text-md text-gray-600 dark:text-gray-400 max-w-md mx-auto">
                        Introduce los detalles y la clasificación del nuevo artículo.
                    </p>
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-x-6 gap-y-8">
                        ...
                        <div class="md:col-span-2">
                            ...
                            <textarea id="descripcion" name="descripcion" rows="3"
                                      ...
                                      class="w-full px-5 py-3 border border-gray-300 dark:border-gray-600 rounded-lg shadow-sm bg-white dark:bg-gray-700 text-gray-900 dark:text-gray-100 placeholder-gray-400 focus:ring-blue-500 focus:border-blue-500 transition @error('descripcion') border-red-500 ring-red-500 @enderror">{{ old('descripcion') }}</textarea>
                            @error('descripcion')
                                <p class="text-red-500 text-xs italic mt-2 flex items-center"><i class="fas fa-info-circle mr-1"></i> {{ $message }}</p>
                            @enderror
                        </div>
                        ...
                        {{-- Campo Estado (Select) --}}
                        <div class="md:col-span-1"> {{-- Mantiene el estado en una sola columna si es necesario --}}
