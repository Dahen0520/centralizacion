<x-app-layout>
    ...
    @php
        // Pre-formatear RTN y Teléfono para mostrarlos correctamente en el input
    ...
    <div class="py-6 flex justify-center">
        <div class="w-full max-w-xl mx-auto">
            <div class="bg-gradient-to-br from-white to-gray-50 dark:from-gray-800 dark:to-gray-900 
                 ...
                 x-data="{ 
                     identificacion: '{{ old('identificacion', $rtn_display) }}', 
                     telefono: '{{ old('telefono', $phone_display) }}' 
                 }">
                ...
                <div class="text-center mb-10">
                    ...
                    <p class="text-md text-gray-600 dark:text-gray-400 max-w-md mx-auto">
                        Modifica los datos del cliente y presiona actualizar.
                    </p>
    ...
    <script>
        ...
        document.addEventListener('DOMContentLoaded', function() {
            // No se necesitan notificaciones de sesión aquí, generalmente se muestran al redirigir al index.
        });
    </script>
</x-app-layout>