            ...
            <div class="bg-gradient-to-br from-white to-gray-50 dark:from-gray-800 dark:to-gray-900 
                ...
                <div class="text-center mb-10">
                    ...
                    <h3 class="text-3xl font-extrabold text-gray-900 dark:text-white mb-2 leading-tight">
                        Ficha de Subcategoría
                    </h3>
                    <p class="text-md text-gray-600 dark:text-gray-400 max-w-md mx-auto">
                        Visualizando la relación y metadatos del producto: <span class="font-bold">{{ $subcategoria->nombre }}</span>
                    </p>
                ...
                <div class="bg-white dark:bg-gray-800 rounded-xl p-8 shadow-xl border border-gray-200 dark:border-gray-700">
                    ...
                    {{-- Nombre de la Subcategoría (Destacado) --}}
                    <h4 class="text-2xl font-semibold text-gray-900 dark:text-white mb-6 border-b pb-3 border-gray-200 dark:border-gray-700 flex items-center">
                        <i class="fas fa-tag mr-3 text-2xl text-purple-600 dark:text-purple-400"></i> {{ $subcategoria->nombre }}
                    </h4>
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6 text-gray-700 dark:text-gray-300">
                        ...
                        <div class="flex items-start">
                            ...
                            <div>
                                ...
                                <p class="text-base font-medium text-gray-700 dark:text-gray-300">{{ $subcategoria->id }}</p>
                            </div>
                        </div>

                        {{-- Nombre --}}
                        <div class="flex items-start">
                            <i class="fas fa-box-open mr-4 text-xl mt-1 text-teal-500 dark:text-teal-400"></i>
                            <div>
                                <p class="text-xs uppercase font-semibold text-gray-500 dark:text-gray-400">Nombre de la Subcategoría</p>
                                <p class="text-base font-normal text-gray-900 dark:text-white">{{ $subcategoria->nombre }}</p>
                            </div>
                        </div>

                        {{-- Categoría Padre --}}
                        <div class="flex items-start">
                            <i class="fas fa-cubes mr-4 text-xl mt-1 text-blue-500 dark:text-blue-400"></i>
                            <div>
                                <p class="text-xs uppercase font-semibold text-gray-500 dark:text-gray-400">Categoría Principal</p>
                                <p class="text-base font-medium text-blue-600 dark:text-blue-400">{{ $subcategoria->categoria->nombre }}</p>
                            </div>
                        </div>
                        ...
                        <div class="flex items-start">
                            ...
                            <div>
                                ...
                                <p class="text-base font-medium text-gray-900 dark:text-white">{{ $subcategoria->created_at->format('d/m/Y H:i') }}</p>
                            </div>
                        </div>
                        ...
                        <div class="flex items-start">
                            ...
                            <div>
                                ...
                                <p class="text-base font-medium text-gray-900 dark:text-white">{{ $subcategoria->updated_at->format('d/m/Y H:i') }}</p>
                            </div>
                        </div>
